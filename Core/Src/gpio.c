...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED_GREEN_Pin|LED_RED_Pin|DCDC_EN_Pin|CFG3_Pin
                          |CFG2_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = LED_GREEN_Pin|LED_RED_Pin|DCDC_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = Headphone_in_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(Headphone_in_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = CFG3_Pin|CFG2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
